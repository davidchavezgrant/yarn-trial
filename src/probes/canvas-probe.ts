...
import { findWindow, onInterrupt, pixelDelta } from "../core/harness.js";
import { startOverlay } from "../core/overlay.js";
import * as axdom from "../core/axdom.js";
 ...
 *
 * Usage: npx tsx src/probes/canvas-probe.ts [x] [y]
		...
		if (x === undefined || y === undefined) {
			...
			console.log(
				`Read the canvas target's pixel coordinates off\n` +
					`${before.shot} and re-run:\n\n  npx tsx src/probes/canvas-probe.ts <x> <y>\n`,
			);
