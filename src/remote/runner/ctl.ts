...
const USAGE = `usage: runnerctl <status|submit|logs|stop|apps|job|doctor|grant|restart|signin|liveview|liveview-stop|peek-prep|ready|authclear|appdelete> [options]
...
const METHODS = new Set(["status", "submit", "logs", "stop", "apps", "job", "doctor", "grant", "restart", "signin", "liveview", "liveview-stop", "peek-prep", "ready", "authclear", "appdelete"]);
