...
const USAGE = `usage: runnerctl <status|submit|logs|stop|apps|job|doctor|grant|restart|signin|liveview|liveview-stop|ready|authclear|appdelete|credexport|credimport> [options]
...
const METHODS = new Set(["status", "submit", "logs", "stop", "apps", "job", "doctor", "grant", "restart", "signin", "liveview", "liveview-stop", "ready", "authclear", "appdelete", "credexport", "credimport"]);
